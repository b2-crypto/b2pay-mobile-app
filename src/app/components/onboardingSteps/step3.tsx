...
import { illustration3 } from './vectors';
...
const stylesCreate = () => {
  ...
  return StyleSheet.create({
    container: {
      ...
      backgroundColor: light.secondary.yellow[400],
    },
    vectorStyle: {
      marginRight: 0,
      zIndex: -1,
    ...
    description: {
      ...
      width: '100%',
      maxWidth: 282,
      color: light.primary.darkPurple[700],
    },
  });
};
const Step3 = () => {
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.contentWrapper}>
        <Text style={styles.description}>{t?.pages.onBoarding['description-step-3']}</Text>
      </View>
    </View>
  );
};
